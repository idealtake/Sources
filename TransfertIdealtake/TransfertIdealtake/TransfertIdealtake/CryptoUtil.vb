...
'
'
'Copyright (C) 2007-2014 VIEIL Thierry Ce programme est un logiciel libre ;
...
Public Class CryptoUtil
    ...
    Public Sub Encrypt(ByVal input As Stream, ByVal output As Stream)
        ...
        Dim buffer(200) As Byte ' tampon utilisé pour la lecture et l'écriture
