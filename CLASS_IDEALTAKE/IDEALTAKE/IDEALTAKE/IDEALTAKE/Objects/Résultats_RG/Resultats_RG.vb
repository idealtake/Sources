Namespace CLASS_IDEALTAKE.Objects
    ...
    Public Class Résultats_recherche_guidée
        Implements IEquatable(Of Résultats_recherche_guidée)
        ...
        Public Overloads Function Equals(ByVal other As Résultats_recherche_guidée) _
      As Boolean Implements IEquatable(Of Résultats_recherche_guidée).Equals
        ...
        Private m_Liste_de_resultats_RG As List(Of Résultats_recherche_guidée)

        Public Property Liste_de_resultats_RG() As List(Of Résultats_recherche_guidée)

            Get
                Return m_Liste_de_resultats_RG
            End Get

            Set(ByVal value As List(Of Résultats_recherche_guidée))
                m_Liste_de_resultats_RG = value
            End Set
